...
Fst, Snd, Pairs (Extra) | ([https://okmij.org/ftp/Haskell/types.html#Prepose)<br />(https://www.youtube.com/watch?v=GawiQQCn3bk](https://en.wikibooks.org/wiki/Haskell/Lists_and_tuples))<br />(https://wiki.haskell.org/User:Michiexile/MATH198/Lecture_4)<br />
Fix Combinator (Extra) | (https://okmij.org/ftp/Haskell/types.html#Prepose)<br />(https://www.youtube.com/watch?v=GawiQQCn3bk)<br />
